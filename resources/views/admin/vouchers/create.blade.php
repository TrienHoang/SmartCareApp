            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h2 class="content-header-title mb-0">Thêm Voucher mới</h2>
                    </div>
            ...
            <div class="col-lg-7">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0"><i class="bx bx-plus me-2"></i> Thông tin Voucher</h4>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.vouchers.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="discount" class="form-control @error('discount') is-invalid @enderror" value="{{ old('discount') }}" min="0" required>
                                @error('discount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-center gap-3 mt-4 pt-2 border-top border-gray-300">
                                <button type="submit" class="btn btn-success btn-lg px-5 py-3 rounded-3 shadow-sm">
                                    <i class="bx bx-save me-2"></i> Tạo mới
                                </button>
