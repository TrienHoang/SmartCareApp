    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
            ...
            <a href="{{ route('admin.vouchers.create') }}"
                class="btn btn-gradient-primary btn-lg d-flex align-items-center gap-2 shadow-sm text-white">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="text-white mb-0">
                                    {{ $stats['active'] ?? $promotions->where('valid_until', '>', now())->count() }}</h4>
                ...
                <div class="card gradient-card bg-gradient-danger">
                    <div class="card-body text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="text-white mb-0">
                                    {{ $stats['expired'] ?? $promotions->where('valid_until', '<', now())->count() }}</h4>
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body">
                <form method="GET" class="row g-3 align-items-end">
                    <div class="col-md-6">
                        <label class="form-label font-weight-semibold"><i class="bx bx-search mr-1 text-primary"></i>Mã
                            voucher</label>
                        <input type="text" name="code" class="form-control" placeholder="Tìm theo mã voucher..."
                            value="{{ request('code') }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label font-weight-semibold"><i class="bx bx-sort mr-1 text-info"></i>Phần trăm
                            giảm giá</label>
                        <div class="row g-2">
                            <div class="col-6">
                                <input type="number" name="discount_percentage_min" class="form-control"
                                    placeholder="Tối thiểu" value="{{ request('discount_percentage_min') }}" min="1">
                            </div>
                            <div class="col-6">
                                <input type="number" name="discount_percentage_max" class="form-control"
                                    placeholder="Tối đa" value="{{ request('discount_percentage_max') }}" min="1">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-header bg-gradient-primary text-white border-0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <span class="badge badge-light text-dark">{{ $promotions->total() }} voucher</span>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="align-middle text-center">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('admin.vouchers.show', $promotion->id) }}"
                                                class="btn btn-outline-info" data-toggle="tooltip" title="Xem">
                                                <i class="bx bx-show-alt"></i>
                                            </a>
                                            <a href="{{ route('admin.vouchers.edit', $promotion->id) }}"
                                                class="btn btn-outline-warning" data-toggle="tooltip" title="Sửa">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                        </div>
                                        <form action="{{ route('admin.vouchers.destroy', $promotion->id) }}"
