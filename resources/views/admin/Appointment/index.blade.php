...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <script>
                            ...
                            <tr>
                                ...
                                <td data-label="Thao tác">
                                    <div class="table-actions d-flex gap-1">
                                        ...
                                        <!-- Hoàn tiền -->
                                        @if ($appointment->status === 'cancelled' && in_array(optional($appointment->payment)->status, ['paid', 'overpaid']) && $appointment->payment->refund_status !== 'completed')
            ...
            <option value="refunded" {{ request('payment_status') == 'refunded' ? 'selected' : '' }}>Đã hoàn tiền
            </option>
            </select>
        </div>
        <div class="col-lg-2 col-md-6 mb-2">
        ...
        <div class="col-lg-4 col-md-6 mb-2 d-flex align-items-end">
            <div class="btn-group w-100" role="group">
                ...
                <a href="{{ route('admin.appointments.index') }}" class="btn btn-outline-secondary mr-2">
                    ...
                    <tr class="appointment-row" data-id="{{ $appointment->id }}">
                        ...
                        <td>
                            <div class="room-info">
                                ...
                                <br><small class="text-muted">{{ $appointment->doctor->department->name ?? '' }}</small>
                            </div>
                        </td>
                        <td>
                            <div class="time-info">
                                <div class="d-flex align-items-center text-info">
                                    ...
                                    <div>
                                        <small class="font-weight-semibold">{{ $appointment->formatted_time }}</small><br>
                                        <small
                            ...
                            <div class="btn-group btn-group-sm" role="group">
                                ...
                                @if ($appointment->status === 'checked_in')
                                    <button class="btn btn-outline-success"
                                        onclick="updateStatus({{ $appointment->id }}, 'completed')" data-toggle="tooltip"
                                        title="Hoàn thành">
                                        <i class="bx bx-check-double"></i>
                                    </button>
                                @endif
                                ...
                                @if (in_array($appointment->status, ['pending', 'confirmed']))
                                    <button class="btn btn-outline-danger"
                                        onclick="showCancelModal({{ $appointment->id }})" data-toggle="tooltip"
                                        title="Hủy lịch hẹn">
                                        <i class="bx bx-x-circle"></i>
                                    </button>
                                @endif
