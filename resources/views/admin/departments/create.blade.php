                    ...
                    <div class="card-body p-5">
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger border-0 shadow-sm mb-4"
                                style="border-radius: 15px; background: linear-gradient(135deg, #ff6b6b, #ee5a52);">
                                <div class="d-flex align-items-center">
                        ...
                        @if (session('success'))
                            <div class="alert alert-success border-0 shadow-sm mb-4"
                                style="border-radius: 15px; background: linear-gradient(135deg, #00c9ff, #92fe9d);">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-check-circle me-3 fa-lg text-white"></i>
                                    <div class="flex-grow-1">
                                        <h6 class="alert-heading text-white mb-1">Thành công!</h6>
                        ...
                        <form action="{{ route('admin.departments.store') }}" method="POST" class="needs-validation"
                            ...
                            <div class="form-floating mb-4">
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="Nhập mô tả phòng ban" rows="4"
                            ...
                            <div class="form-floating mb-5">
                                <select name="is_active" id="is_active"
                                    ...
                                    style="border-radius: 15px; border: 2px solid #e9ecef; transition: all 0.3s;" required>
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                <button type="submit" class="btn btn-primary btn-lg px-5 py-3 shadow-lg"
                                    style="border-radius: 15px; background: linear-gradient(135deg, #667eea, #764ba2); border: none; transition: all 0.3s;">
                                    <i class="fas fa-save me-2"></i>
                                    Tạo phòng ban
                                </button>
                                <a href="{{ route('admin.departments.index') }}"
                                    class="btn btn-outline-secondary btn-lg px-5 py-3 shadow-sm"
                                    style="border-radius: 15px; border: 2px solid #6c757d; transition: all 0.3s;">
