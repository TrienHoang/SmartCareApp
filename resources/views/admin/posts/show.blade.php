                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-0">
                            <div class="position-relative overflow-hidden rounded">
                                <img src="{{ asset('storage/' . $post->thumbnail) }}" class="img-fluid w-100"
                                    style="max-height: 400px; object-fit: cover;" alt="{{ $post->title }}">
                                <div
                                    class="position-absolute top-0 start-0 w-100 h-100 bg-gradient-to-bottom from-transparent to-dark opacity-20">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center py-3">
                                ...
                                <div class="view-count-display">
                                    <span
                                        class="view-count-number fw-bold text-primary">{{ number_format($post->view_count) }}</span>
