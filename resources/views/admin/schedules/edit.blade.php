            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4">
                        ...
                        <!-- Form -->
                        <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST" id="formChinhSuaLich" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <!-- Left Column -->
                                <div class="col-lg-8">
                                    <div class="form-section mb-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control @error('day') is-invalid @enderror" id="ngay" name="day" value="{{ old('day', $schedule->day) }}" required>
                                            @error('day')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" class="form-control @error('start_time') is-invalid @enderror" id="gio_bat_dau" name="start_time" value="{{ old('start_time', $schedule->start_time) }}" required>
                                            @error('start_time')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" class="form-control @error('end_time') is-invalid @enderror" id="gio_ket_thuc" name="end_time" value="{{ old('end_time', $schedule->end_time) }}" required>
                                            @error('end_time')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        capNhatThuTuNgay(inputNgay.value);
