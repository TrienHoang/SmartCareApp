    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0" style="color: rgb(62, 61, 61); font-weight: bold;"><i class="bx bx-receipt"></i> Danh sách
                    đơn hàng</h4>
            </div>
            <div class="card-body">
                @if (session('error'))
                ...
                <form method="GET" class="row g-3 mb-4">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('orders.index') }}" class="btn btn-secondary w-100"><i class="bx bx-reset"></i>
                            Xóa lọc</a>
                    </div>
