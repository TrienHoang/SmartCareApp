                ...
                <tbody class="text-center">
                    @forelse ($prescriptions as $prescription)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.prescriptions.show', $prescription->id) }}" class="btn btn-sm btn-info me-1">
                                    <i class="bx bx-show"></i> Xem
                                </a>
                                <a href="{{ route('admin.prescriptions.edit', $prescription->id) }}" class="btn btn-sm btn-warning">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-muted">Không có đơn thuốc nào.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
