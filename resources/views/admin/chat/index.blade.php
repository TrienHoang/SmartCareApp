                                                    ...
                                                    <div class="latest-message-content">
                                                        <div class="text-truncate" style="max-width: 250px;">
                                                            @if ($session->latestMessage->sender_type === 'admin')
                                                                <span class="text-primary"><i class="fas fa-reply"></i> Bạn:
                                                                </span>
        ...
        class ChatNotificationManager {
            ...
            setupRealtime() {
                ...
                window.Echo.channel('chat-global')
                    ...
                    .subscribed(() => {
                        console.log('✅ Successfully subscribed to admin chat notifications');
                    })
                    .error((error) => {
                        console.error('❌ Failed to subscribe to admin chat notifications:', error);
                    });
            ...
            handleNewMessage(data) {
                ...
                // Skip if message is from admin/receptionist (our own messages)
                if (['admin', 'receptionist'].includes(data.sender_type)) {
                    return;
                }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                ...
                if (sessionLink) {
                    ...
                    if (sessionRow) {
                        ...
                        window.chatNotificationManager.markSessionAsRead(sessionId);
                    }
                }
            });
            ...
            setInterval(function() {
                if (!document.hidden) {
                    ...
                    // window.chatNotificationManager.refreshSessions();
                }
            }, 30000);
            ...
            console.log('✅ Chat Index with Realtime Notifications ready!');
        });
        ...
        window.ChatNotifications = {
            clearUnread: (sessionId) => {
                if (window.chatNotificationManager) {
                    window.chatNotificationManager.clearUnreadCount(sessionId);
                }
            },
            ...
            getTotalUnread: () => {
                return window.chatNotificationManager ? window.chatNotificationManager.totalUnread : 0;
            }
        };
    </script>
@endpush
