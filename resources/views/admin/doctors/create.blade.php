                        ...
                        <form action="{{ route('admin.doctors.store') }}" method="POST">
                            ...
                            <div class="col-12 mb-3">
                                <label for="user_id" class="form-label font-weight-semibold">
                                    <i class="fas fa-user me-1"></i> Nhập ID người dùng <span class="text-danger">*</span>
                                </label>
                                <input type="number" min="1" name="user_id" id="user_id"
                                    class="form-control @error('user_id') is-invalid @enderror"
                                    placeholder="Nhập ID người dùng..." value="{{ old('user_id') }}" required>
                                @error('user_id')
