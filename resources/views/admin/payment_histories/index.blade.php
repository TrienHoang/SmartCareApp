...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <!-- Filter Form -->
        <form method="GET" action="{{ route('admin.payment_histories.index') }}"
            class="row g-3 justify-content-center mb-4">
            <div class="col-md-3">
                <input type="text" name="patient_name" class="form-control" placeholder="Tên bệnh nhân"
                    ...
                    <tbody>
                        @foreach($histories as $history)
                            <tr>
                                ...
                                <td>{{ optional($history->payment->appointment->patient)->full_name ?? 'Không có' }}</td>
                                ...
                                <td>{{ $history->payment_date ? \Carbon\Carbon::parse($history->payment_date)->format('d/m/Y H:i') : 'Chưa thanh toán' }}
                                </td>
                                <td>
