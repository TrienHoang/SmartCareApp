                ...
                <div class="col-12">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div class="form-check">
                            <input type="radio" name="leave_type" id="normal" value="normal" class="form-check-input"
                                   {{ old('leave_type', 'normal') === 'normal' ? 'checked' : '' }}>
                            <label class="form-check-label" for="normal">Nghỉ thường</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" name="leave_type" id="vacation" value="vacation" class="form-check-input"
                                   {{ old('leave_type') === 'vacation' ? 'checked' : '' }}>
                            <label class="form-check-label" for="vacation">Nghỉ du lịch</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" name="leave_type" id="emergency" value="emergency" class="form-check-input"
                                   {{ old('leave_type') === 'emergency' ? 'checked' : '' }}>
