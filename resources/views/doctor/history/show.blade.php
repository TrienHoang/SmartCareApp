        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                @if ($appointment->medicalRecord->prescription)
                    <div class="mt-3">
                        <h6><strong>Đơn thuốc</strong></h6>
                        <p><strong>Ngày kê đơn:</strong>
                            {{ \Carbon\Carbon::parse($appointment->medicalRecord->prescription->prescribed_at)->format('d/m/Y') }}
                        </p>
                        ...
                        {{-- Danh sách thuốc --}}
                        @if ($appointment->medicalRecord->prescription->items->count() > 0)
