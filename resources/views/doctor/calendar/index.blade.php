...
@section('content')
    <style>
        ...
        /* Status Colors */
        .fc-event.event-past,
        .fc-event.appointment.event-past {
        ...
        .fc-event.event-near-due,
        .fc-event.appointment.event-near-due {
            background-color: var(--color-yellow-bg) !important;
        ...
        .fc-event.event-normal {
            ...
            border: 1px solid var(--color-green-border) !important;
