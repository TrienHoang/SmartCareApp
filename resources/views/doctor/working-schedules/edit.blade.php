    ...
    <div class="form-container">
        ...
        <form action="{{ route('doctor.working_schedules.update', $schedule->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ Auth::user()->doctor->room->name ?? 'Chưa phân phòng' }}" disabled>
            </div>

            <div class="mb-3">
                <label for="day" class="form-label">Ngày làm việc</label>
                <input type="date" id="day" name="day" class="form-control" value="{{ old('day', $schedule->day) }}" required>
            </div>
