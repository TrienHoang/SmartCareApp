                ...
                <form method="POST" action="{{ route('doctor.files.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="note" rows="3" placeholder="Mô tả ngắn về file..."
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('note') }}</textarea>
                            @error('note')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
