        ...
        <div
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
                <div class="relative flex-shrink-0">
                    ...
                    <div class="absolute bottom-2 right-2 bg-green-500 w-5 h-5 rounded-full border-3 border-white shadow-sm">
                    </div>
                </div>
            ...
            <div
                ...
                <div class="space-y-5">
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 last:border-b-0">
                        ...
                        <span class="text-gray-900 font-semibold">{{ Auth::user()->full_name }}</span>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-100 last:border-b-0">
                    ...
                    <div class="flex justify-between items-center py-3 last:border-b-0">
                        ...
                        <span
                            class="text-gray-900 font-semibold">{{ Auth::user()->date_of_birth ? \Carbon\Carbon::parse(Auth::user()->date_of_birth)->format('d/m/Y') : 'Chưa cập nhật' }}</span>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="space-y-5">
                    ...
                    <div class="py-3 last:border-b-0">
                        ...
                        <p class="text-gray-900 font-semibold leading-relaxed">
                            {{ Auth::user()->description ?? 'Chưa cập nhật' }}</p>
                    </div>
                </div>
            </div>
